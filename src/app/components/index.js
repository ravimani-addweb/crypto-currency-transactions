...
//Set Password directive for Premium
import okPasswordPremium from './checkStrengthPremium.directive';
componentsModule.directive('okPasswordPremium',okPasswordPremium);

//Set Password directive for Brain
import okPasswordBrain from './checkStrengthBrain.directive';
componentsModule.directive('okPasswordBrain',okPasswordBrain);
...
// Set string-to-number attribute directive
import StringToNumber from './stringToNumber.directive';
componentsModule.directive('stringToNumber', StringToNumber);
