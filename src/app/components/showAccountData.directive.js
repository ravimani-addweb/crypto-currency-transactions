        ...
        link: function(scope, element, attrs) {
            ...
            scope.$watch('DataBridge.accountData', function(val) {
                if (val) {
                    ...
                    } else if (attrs.showAccountData === 'address' && attrs.showTextArea !== undefined) {
                        element.html("<textarea style='border: 0px !important; background: transparent;'>" + $filter('fmtAddress')(val.account.address) + "</textarea>")
                    } else if (attrs.showAccountData === 'address') {
                        element.html("<span style='border: 0px !important; background: transparent;'>" + $filter('fmtAddress')(val.account.address) + "</span>")
