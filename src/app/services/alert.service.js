export default class Alert {
     ...
     */
     emailRequired(){
       this._ngToast.create({
           className: 'danger',
           content: this._$filter('translate')('ALERT_EMAIL_DATA')
       });
     }
     emailNotValid() {
         this._ngToast.create({
             className: 'danger',
             content: this._$filter('translate')('ALERT_VALID_EMAIL_DATA')
         });
     }
    missingFormData() {
        this._ngToast.create({
    ...
    badPasswordData() {
        this._ngToast.create({
            className: 'danger',
            content: this._$filter('translate')('ALERT_BAD_PASSWORD_DATA')
        });
    }
    ...
    badPasswordData2() {
        this._ngToast.create({
            className: 'danger',
            content: this._$filter('translate')('ALERT_BAD_PASSWORD_DATA_2')
        });
    }
    ...
    checkPasswordbox(){
      this._ngToast.create({
          content: this._$filter('translate')('CHECK_PASSWORD__CHECKED'),
          className: 'danger'
      });
    }
    ...
    copiedClipboard() {
      this._ngToast.create({
          content: this._$filter('translate')('COPIED_CLIPBOARD'),
          className: 'success'
      });
    }
    ...
    errorGetFiatRates() {
        this._ngToast.create({
            content: this._$filter("translate")("ALERT_CURRENCIES_EXCHANGE_DOWN"),
            className: 'danger'
        });
    }
    ...
    premiumPasswordTooShort() {
        this._ngToast.create({
            className: 'danger',
            content: this._$filter('translate')('ALERT_PREMIUM_PASSWORD_TOO_SHORT')
        });
    }

    basicWalletMustBeLoaded() {
        this._ngToast.create({
            className: 'danger',
            content: this._$filter('translate')('ALERT_BASIC_WALLET_MUST_BE_LOADED')
        });
    }
