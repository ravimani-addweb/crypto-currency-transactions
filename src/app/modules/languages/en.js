function EnglishProvider($translateProvider) {
    ...
    $translateProvider.translations('en', {
        ...
        //dasboard component
        SEND_RECEIVED: 'Send/Received',
        DECRYPT_MESSAGE: 'Decrypt Message',

        //subscribe success
        VIP_WALLET_SUBSCRIBE:' Your request has been sent!',
        VIP_WALLET_SUBSCRIBE_INFO:'A representative will contact you shortly with further information about your wallet. Thank you for contacting DEPOTWALLET!',
        //Passsword Validation
        PASSWORD_VALIDATION_1: 'Very weak! It would take about 1 second to crack this password',
        PASSWORD_VALIDATION_2: 'Intermediate! It would take about 1 day to crack this password',
        PASSWORD_VALIDATION_3: 'Average! It would take about 1 month to crack this password',
        PASSWORD_VALIDATION_4: 'Strong! It would take about 1 year to crack this password',
        PASSWORD_VALIDATION_5: 'Very strong! It would take about 2 year to crack this password',

        //GENRAL
        DEFAULT_SCREEN:'Reset to original settings',
        HELP_QUESTION:'Need help (Auto response E-Mail)',
        HELP_ANSWER:'Your inquiry is important to us. A consultant will contact you shortly.',
        ALERT_EMAIL_DATA: "Enter email Address !",
        ALERT_VALID_EMAIL_DATA:'Email not Valid !',
        WALLET_EXPORT_TITLE: 'Export your Wallet',
        ACCOUNT_BACKUP_WALLET_SELECT: 'Select wallet',
        EURO: 'Euro',
        GB_POUNDS: 'Pound',
        TOTAL_CURRENCIES: 'Total Currencies',
        NODE_ANSWER: 'The node is a point in a network at which lines or pathways intersect or branch. When the DEPOTWALLET node is green you can access your wallet, when the node is red you cannot access your wallet and need to click on the node until it turns green.',
        WLLET_ADDRESS_INFO_Q: 'Account Address information',
        WLLET_ADDRESS_INFO_A: 'Your DEPOTWALLET address is the means by which you receive your coins. When you buy or sell coins, this address is what links you to your transaction, and functions as the address used by others to pay coins to you.',
        ENCRYPT_DEFINITION: 'Encrypt Definition',
        ENCRYPT_DEFINITION_ANSWER: 'Converts your information or data into code which helps prevent unauthorized access. Encryption is important because it helps you to securely protect data against identity theft and fraud.',
        DECRYPT_DEFINITION: 'Decrypt Definition',
        DECRYPT_DEFINITION_ANSWER: 'Converts your information back into intelligible information or data after encryption.',
        ...
        BASIC_WALLET_QUESTION: 'Why a Basic Wallet?',
        BASIC_WALLET_ANSWER: 'The Basic Wallet does NOT require a login keyfile in addition to your password to access your account. This account is ideal for individuals who are using an online wallet for the first time and do not plan to store more than $500 worth of coins. Otherwise we recommend using our Premium Wallet.',
        BASIC_WALLET_OPEN_ACCOUNT: 'Open Basic Wallet',

        PRIMIUM_WALLET_QUESTION: 'Why a Premium Wallet?',
        PRIMIUM_WALLET_ANSWER: 'The Premium Wallet does require a login key for the user to access the account, offering the highest level of security. This account is ideal for individuals who have used an online wallet before. Please be advised to backup your “.wlt” file and your password in multiple locations such as USB Stick or External HD.',
        PRIMIUM_WALLET_OPEN_ACCOUNT: 'Open Premium Wallet',

        VIP_WALLET_QUESTION: 'Why a VIP Wallet?',
        VIP_WALLET_ANSWER: 'The VIP wallet is registered and managed by the DEPOTWALLET team. This wallet is ideal for individuals who prefer not to manage their own account.',

        VIP_WALLET_LOW_FEES_QUESTION: 'VIP Wallet fees information:',
        VIP_WALLET_LOW_FEES_ANSWER: 'USD $999 per annum.',

        VIP_WALLET_PRISE_LIST: 'View price list',
        VIP_WALLET_OPEN_ACCOUNT: 'Subscribe',
        VIP_WALLET_SUBSCRIB_EMAIL_LABEL: 'Your E-Mail',
        VIP_WALLET_SUBSCRIB_EMAIL_PLACEHOLDER: 'info@johndoe',
        VIP_WALLET_SUBSCRIB_BUTTON: 'Subscribe',

        BASIC_WALLET_INFO_1: 'First step of registration',
        BASIC_WATCH_VIDEO: 'Watch Video',
        BASIC_VIEW_PDF: 'View PDF',
        BASIC_CONTINUES: 'Continue',
        ACCOUNT_COMMON_WALLET_WARNING_CONFIRM: 'I agree',
        FORM_WALLET_NAME_PLACEHOLDER: 'E.G. John Private Account',
        SIGNUP_CREATE_WALLET_PRIMIUM_BUTTON: 'Create Premium Wallet',

        //Open Account
        ACCOUNT_WARNING_1: 'Account safety warning',
        ACCOUNT_WARNING_2: 'Download .wlt file',
        ACCOUNT_WARNING_3: 'Save your .wlt file externally',
        ACCOUNT_WARNING_4: 'Your Private Key',
        ACCOUNT_WARNING_5: 'Save your Private Key offline',
        ACCOUNT_WARNING_6: 'Finish your registration',

        ACCOUNT_WARNING_INFO_1: "Wallets are stored temporarily in the browser local storage. Browsers can be configured (e.g. by add-ons) to clear the local storage times. This will lead to the loss of the data, which cannot be easily undone.In such a case, your wallets will not be accessible. It is of utmost importance that you have all the information and data (.wlt) needed to restore your accounts.",
        ACCOUNT_WARNING_INFO_2_1: "You should have triggered a download after creating the wallet. This is the “.wlt“ file used to backup and import if your browser’s local storage is erased.",

        ACCOUNT_WARNING_INFO_2_2: "If you didn’t get a backup “.wlt” file, click on the button below to reveal the raw wallet data and create the file manually.",
        ACCOUNT_WARNING_INFO_3: "Save your “.wlt” file on external storage. This could be on a USB flash drive or an external hard drive. You should keep this file and password in a safe place as this is the access to your account. If this file is lost it cannot be recovered.",
        ACCOUNT_WARNING_INFO_4: "Even if you have a wallet file it is mandatory to backup your account’s Private Key. You should keep this file in a safe place as this is the access to your account. If this file is lost it cannot be recovered. Click below to reveal your Private Key:",

        ACCOUNT_WARNING_INFO_5: "To backup your Private Key, save it in a text file, print it or write it down somewhere safe. It is recommended to store the private key offline. It is your responsibility to always make sure you have your private key backed up.",
        ACCOUNT_WARNING_INFO_6: "By clicking below, you agree that you have read and understood the above security warnings.",
        CHECK_PASSWORD__CHECKED: 'Please fill password checkbox ',

        //open Account Agrree btn
        ACCOUNT_AGRREE_PASSWORD: 'I have my password',
        ACCOUNT_AGRREE_WALLET_FILE: 'I have my “.wlt” keyfile',
        ACCOUNT_AGRREE_PRIVATE_KEY: 'I have written down on paper my Private Key',

        BASIC_PASSWORD_REQ: 'Password Requirements',
        BASIC_PASSWORD_QUESTION_1: '',
        BASIC_PASSWORD_ANSWER_1: 'DEPOTWALLET strongly recommends the use of password management software such as Keepass, <u> 1Password</u> or <u>Lastpass.</u> A password manager can generate random, unique passwords for each website you visit. It can also automatically fill in passwords for you and can protect you against phishing attacks.',
        BASIC_PASSWORD_QUESTION_2: 'How do I choose a good password?',
        BASIC_PASSWORD_ANSWER_2: "If you don’t want to use a password manager, be sure to use a long, random password that is unique to your DEPOTWALLET account. DO NOT reuse passwords from other websites, especially your email account. DO use a passphrase (a sentence or group of words), but DO NOT use a phrase from a book or movie as hackers have access to sophisticated databases of such quotes. Your password should contain a minimum of 64 characters.",


        PRIMIUM_PASSWORD_REQ: 'Password Requirements',
        PRIMIUM_PASSWORD_QUESTION_1: '',
        PRIMIUM_PASSWORD_ANSWER_1: 'DEPOTWALLET strongly recommends the use of password management software such as Keepass, <u>1Password</u> or <u>Lastpass.</u> A password manager can generate random, unique passwords for each website you visit. It can also automatically fill in passwords for you and can protect you against phishing attacks.',
        PRIMIUM_PASSWORD_QUESTION_2: 'How do I choose a good password?',
        PRIMIUM_PASSWORD_ANSWER_2: "If you don’t want to use a password manager, be sure to use a long, random password that is unique to your DEPOTWALLET account. DO NOT reuse passwords from other websites, especially your email account. DO use a passphrase (a sentence or group of words), but DO NOT use a phrase from a book or movie as hackers have access to sophisticated databases of such quotes. Your password should contain a minimum of 30 characters.",

        WALLET_NAME_REQ: 'Wallet Name Information',
        WALLET_NAME_QUESTION_1: '',
        WALLET_NAME_ANSWER_1: 'The name you give your wallet when you create a DEPOTWALLET account.',
        WALLET_NAME_QUESTION_2: '',
        WALLET_NAME_ANSWER_2: "",

        ACCOUNT_INFO_PUBLIC_TITLE: 'Public Key',
        PASSWORD_PUBLIC_REQ: '',
        PASSWORD_PUBLIC_QUESTION_1: 'Account Public Key information',
        PASSWORD_PUBLIC_ANSWER_1: 'This is the extended version of the DEPOTWALLET address from which other addresses are created.',

        ACCOUNT_INFO_SCORE_TITLE: 'Importance score title',
        PASSWORD_SCORE_REQ: 'Importance score Requrement',
        PASSWORD_SCORE_QUESTION_1: 'Importance score Question ?',
        PASSWORD_SCORE_ANSWER_1: 'Importance score Answer',

        ACCOUNT_INFO_BALANCE_TITLE: 'Vested balance title',
        PASSWORD_BALANCE_REQ: ' Vested balance Requrement',
        PASSWORD_BALANCE_QUESTION_1: 'Vested balance Question ?',
        PASSWORD_BALANCE_ANSWER_1: 'Vested balance Answer',

        //Steps Arrow btn
        STEP_BIP32: 'More information about BIP32',
        STEP_ROW_FILE: 'Show raw wallet file',
        STEP_DOWNLOAD_FILE: 'Download file',
        STEP_SHOW_PRIVATE_KEY: 'Show private key',
        STEP_DOWNLOAD_PRIVATE_KEY: 'Download Private Key',

        RECOVER_WALLET_INFO: 'Recover Wallet',
        RECOVER_WALLET_P1: 'Your wallet can be recovered if lost by using your Private Key.',

        //Footer
        FOOTER_DESCLIMER: 'Disclaimer',
        FOOTER_TIMEZONE: 'Timezone: GMT',

        //Disclimer page
        DISCLIMER_TITLE: 'Disclaimer',
        DISCLIMER_QUESTION: '',
        DISCLIMER_ANSWER: 'DEPOTWALLET is not responsible for the safe-keeping of wallet addresses, private keys or passwords. Once a private key has been lost it cannot be recovered by DEPOTWALLET as back-ups and storage are the responsibility of the user.',
        ...
        //Dashboard page
        DASHBOARD_TITLE_ADDRESS: 'Your Account Address',
        DOWNLOAD: 'Download',
        COPY: 'Copy',
        VIEW: 'View',
        INFO: 'Info',
        ...
        US_DOLLAR: 'US-Dollar',
        IN_RUPEE: 'IN-Rupee',
        CHF_FRANCE: 'CHF-Swiss Franc',

        STOCK_EXCHANGE: 'Stock Exchange',
        OTC_MARKET: 'OTC Market',
        CURRENCIES: 'Currencies',
        YOUR_CURRENCIES: 'Your Currencies',
        YOUR_SETTING: 'Your Setting',
        SELECT_LANGUAGE: 'Select Language',
        SELECT_YOUR_LANGUAGE: 'Select your language',
        SELECT_LANGUAGE_INTRO: 'This page is available in the following languages:',
        CHANGE_BACK_COLOR: 'Change background color',
        QR_CODE_INFO: 'Only NEM based coins can be utilized with the DEPOTWALLET. Not all altcoins can be sent and received via the DEPOTWALLET. Tradable altcoins include: XEM, DIM',
        QR_CODE_TITLE: 'Account Address QR code safety warning',
        ...
        //Exchange page
        EXCHANGE_LABEL_CURRENCY: 'Select Currency',
        EXCHANGE_LABEL_SELECT_PAYMENT: 'Select Payment Method',

        //tranfer tranjection
        GENRAL_NEXT: 'Next',
        GENRAL_BACK: 'Back',
        VIEW_BLOCKCHAIN: 'View in the Blockchain',
        HISTROY_RESENT_ACTIVITY: 'History of recent activities',
        ...
        //recover wallet
        GENRAL_FIND: 'Find',
        RECOVER_INFO_TITLE: 'Recover Wallet ',
        RECOVER_PASSWORD_REQ: 'Private Key Information',
        RECOVER_PASSWORD_QUESTION_1: 'Why Private Key Information?',
        RECOVER_PASSWORD_ANSWER_1: 'The Private Key is a sophisticated form of cryptography that allows you to access the cryptocurrency within your DEPOTWALLET. The Private Key is integral to the use of cryptocurrency as its security make-up helps ensure your protection against unauthorized access to funds.',


        // HEADER COMPONENT
        WALLET_NAME_1: 'Depot',
        WALLET_NAME_2: 'Wallet',
        APP_NAME_SUB: 'The secure interface connecting to the DEPOTWALLET platform',
        HEADER_LOGIN_BUTTON: 'Login',
        HEADER_SIGNUP_BUTTON: 'Open Account',
        HEADER_SIGNUP_WARNNING: 'Instructions for safety',
        ...
        // MENU
        MENU_DIMCOIN: 'Exchange',
        MENU_DIMCOIN_EXCHANGE: 'DIMCOIN Exchange',
        MENU_TRANSFER: 'Transfer',
        MENU_DASHBOARD: 'Dashboard',
        MENU_ASSETS: 'Asset Market',
        MENU_FAQ: 'Support Center',
        ...
        DASHBOARD_TOTAL_ASSETS_TITLE: 'Total Assets',
        ...
        GENERAL_SELL: 'Sell',
        GENERAL_BUY: 'Buy',
        GENERAL_PLEASE_SELECT: 'Select a currency',
        ...
        TRANSFER_TRANSACTION_TITLE: 'Send and Receive',
        ...
        TRANSFER_TRANSACTION_SIDEBAR2_TITLE: 'Asset Transfer',
        TRANSFER_TRANSACTION_SIDEBAR3_TITLE: 'Encrypted Message',
        TRANSFER_TRANSACTION_SIDEBAR1_TEXT: 'Enter your password, specify where you want to send the coins to, enter an amount and click on “submit”. This requires fees.',
        TRANSFER_TRANSACTION_SIDEBAR2_TEXT: 'You can send your assets by selecting the “Yes” checkbox on “Asset Transfer”. This requires fees.',
        TRANSFER_TRANSACTION_SIDEBAR3_TEXT: 'Check “Yes” if you would like to encrypt your message, this is highly recommended. This requires fees.',
        TRANSFER_TRANSACTION_NEEDSXEM_TEXT: 'Please note, that you can’t make a transaction without XEM. Please find more information regarding purchasing XEM on <a href="https://changelly.com" target="_blank" style="font-size: 18px;">changelly.com</a> or <a href="https://shapeshift.io" target="_blank" style="font-size: 18px;">shapeshift.io</a>.',

        //
        TOOLTIPS_ACCOUNT_INFO: 'Instructions for Safety',
        ...
        LINE_VIEW_TRNSFR: 'View Transfer',
        ...
        MOSAIC_DEFINITION_INFORMATION_16: 'Sending mosaics on the Depot blockchain requires a fee. The exact fee is calculated depending on their total number and how many are being sent during a transaction. <b>Small business mosaics</b> are given a discounted flat rate of 1 depot coin per mosaic per transfer.  These are mosaics with a quantity of less than 10,000 and a divisibility of 0.',
        ...
        RENEW_NS_INFORMATION_1: 'Renewing a namespace costs the same amount as registering a new namespace, 5000 XEM.',
        ...
        ACCOUNT_HARVESTING_BELOW_THRESHOLD: 'You need 10\'000 vested depot coin to start delegated harvesting',
        ...
        ACCOUNT_PRIVATE_KEY_NOTE: 'Your private key holds all the power of your account. It is a priority to make sure it is stored safely somewhere offline: password encrypted into a .wlt file, written on a piece of paper, on a picture or download the export wallet QR.',
        ACCOUNT_PRIVATE_KEY_SHOW: 'Show private key',
        ACCOUNT_EXPORT_MOBILE: 'Export',
        ACCOUNT_INFO_TITLE: 'Export your Wallet',
        ACCOUNT_INFO_QR_BTN: 'Account Info',
        ACCOUNT_WALLET_QR_BTN: 'Wallet',
        ACCOUNT_WALLET_QR_BTN_2: 'Android/iOS',
        ACCOUNT_BACKUP_WALLET: 'Backup',
        ACCOUNT_BACKUP_WALLET_NOTE: 'It is very important that you have backups of your wallets to log in with, or your XEM will be lost!',
        ACCOUNT_BACKUP_WALLET_DOWNLOAD: 'Download wallet',
        ACCOUNT_INFO_QR_TITLE: 'Account information QR',
        ACCOUNT_WALLET_QR_NOTE: 'This QR is only working on upcoming Depotpay mobile app.',
        ACCOUNT_WALLET_QR_ANDROID_IOS_TITLE: 'Wallet QR for Android & IOS apps',
        ACCOUNT_ADD_NEW_ACCOUNT_WARNING: 'All accounts are derived from your main private key using BIP32, so only one private key and your password are needed to retrieve all your other accounts. <br>It is still <b><u>highly recommended</u></b> to backup your wallet after adding new accounts to not repeat the operation again if local storage is erased.',
        ...
        PORTAL_CHANGELLY_TEXT: 'Use the Changelly widget to exchange depot coin at the best rates !',
        PORTAL_CHANGELLY_BTN: 'Buy depot coin',
        ...
        PORTAL_MOSAIC_TEXT: 'Depot mosaics are assets that expose additional properties and other features. To be able to create a mosaic, an account must rent at least one root namespace.',
        PORTAL_MOSAIC_BTN_1: 'Create mosaic',
        PORTAL_MOSAIC_BTN_2: 'Edit mosaic',
        PORTAL_APOSTILLE_TITLE: 'Apostille',
        PORTAL_APOSTILLE_TEXT: 'Use the Depot Apostille service to create blockchain based notarizations to time stamp, follow and audit file authenticity.',
        ...
        // ASSETS EXPLORER
        ASSETS_EXPLORER_MAX_QUANTITY: 'Max buyable quantity',
        ...
        APOSTILLE_INFORMATION_8: 'After the transactions are sent the download of an archive is triggered. It contains your signed files, your Apostille certificate for that file, and the new or updated .nty file to keep track of every file you time stamped on the Depot chain.',
        ...
        ALERT_BAD_PASSWORD_DATA: 'Please enter a password with minimum length of 64 having at-least 1 CAPITAL letter, 1 number and 1 special character. Space is not allowed.',
        ALERT_BAD_PASSWORD_DATA_2: 'Please enter a password with minimum length of 30 having at-least 1 CAPITAL letter, 1 number and 1 special character. Space is not allowed.',
        ...
        ALERT_CURRENCIES_EXCHANGE_DOWN: 'An error occured: Currencies can currently not be converted',
        ALERT_BRAIN_WALLET_UPGRADE: '<span>Your password seems weak! We advise you to use a passphrase with a minimum of 64 characters.</span><br /><span>If you still got a “Basic Wallet” we advise you to create a new “Premium Wallet” and transfer your funds into it.</span><br/><span>',
        ALERT_BRAIN_PASSWORD_TOO_SHORT: 'Your basic wallet passphrase must be at least 64 characters!',
        ALERT_PREMIUM_PASSWORD_TOO_SHORT: 'Your premium wallet passphrase must be at least 64 characters!',
        ALERT_BASIC_WALLET_MUST_BE_LOADED: 'Please open an account before you can login to your Basic Wallet!',
        ALERT_BRAIN_WALLET_UPGRADE_TITLE: 'Security Warning',
        ...
        // LOGIN MODULE
        LOGIN_MEMBER_TITLE: 'Already a DEPOTWALLET Investor?',
        ...
        LOGIN_SELECT_WALLET: 'Select a wallet in storage Mainnet',
        LOGIN_LOGIN_BUTTON: 'Sign in',

        // SIGNUP MODULE
        SIGNUP_TITLE: 'New to DEPOTWALLET?',
        SIGNUP_CREATE_WALLET_TITLE: 'Advanced wallet',
        SIGNUP_PRIVATE_KEY_WALLET_TITLE: 'Private Key wallet',
        SIGNUP_BRAIN_WALLET_TITLE: 'Basic wallet',
        SIGNUP_CREATE_WALLET_BUTTON: 'Create advanced wallet',
        SIGNUP_PRIVATE_KEY_WALLET_BUTTON: 'Create private key wallet',
        SIGNUP_BRAIN_WALLET_BUTTON: 'Create Basic Wallet',
        SIGNUP_CREATE_WALLET_WARNING: 'Please read about <a href="https://www.w3.org/TR/2014/WD-WebCryptoAPI-20140325/#RandomSource-interface" rel="nofollow" target="_blank">dangers</a> that client side generated keys pose; we are not responsible for any loss that could be due to the entropy of key generation. Even if it is unlikely to happen, it is still recommended to use a private key generated from a Depot client.',
        SIGNUP_NETWORK_SELECT: 'Select a network',
        SIGNUP_BRAIN_WALLET_WARNING: 'Please read about <a href="https://en.bitcoin.it/wiki/Brainwallet" rel="nofollow" target="_blank">dangers</a> that basic wallet poses. Basic wallet uses ONLY password hashed multiple times, therefore it\'s crucial to select a SAFE password. <a href="https://xkcd.com/936/" rel="nofollow" target="_blank">XKCD #936</a>',
        ...
        SIGNUP_COMMON_WALLET_WARNING_1: 'Wallets are stored temporarily in the browser local storage! Browsers can be configured (e.g. by add-ons) to clear the local storage at times. This will lead to the loss of the data and which can\'t be undone easily. In such a case, your wallets will be gone, so it is very important to make sure you have all needed information to restore your accounts.',
        ...
        SIGNUP_COMMON_WALLET_WARNING_CONFIRM_3: 'I Accept',
        SIGNUP_COMMON_WALLET_WARNING_CONFIRM_4: 'I have read the Instructions for safety and accepted',

        // FAQ MODULE
        FAQ_TITLE: 'Frequently asked questions',
        FAQ_QUESTION_1: 'What is DEPOTWALLET?',
        FAQ_ANSWER_1: 'We provide a state-of-the-art 2-in-1 Blockchain Wallet called DEPOTWALLET. Coins Wallet: Buy, Sell and Hold your DIMCOIN in a secure place that you can access from anywhere via the Internet.<br><br> Assets Wallet: Buy, Sell and Hold your Assets like stocks and ETFs and e-commerce on DEPOTWALLET.',

        FAQ_QUESTION_2: 'What is DIMCOIN?',
        FAQ_ANSWER_2: 'DIMCOIN is a digital currency that belongs to a growing category of digital money called cryptocurrency. It is created and stored electronically and is completely decentralized. Transactions can be performed without the need for financial institutions. It is designed to enable users to send money over the Internet in a very simple and efficient way.',

        FAQ_QUESTION_3: 'Why use DIMCOIN?',
        FAQ_ANSWER_3: 'There are a number of advantages to using cryptocurrencies like DIMCOIN, some of which include: ',
        FAQ_ANSWER_3_LI1: 'Security - you remain in control of your transactions and are safe from identity theft as no personal information is associated with the transaction.',
        FAQ_ANSWER_3_LI2: 'Low Cost - with extremely low transaction fees or third parties involved, the costs of buying and selling are reduced significantly.',
        FAQ_ANSWER_3_LI3: 'Fast and Convenient - You can send and receive DIMCOIN anywhere across the globe in a matter of minutes.',

        FAQ_QUESTION_4: 'How do I get DIMCOIN?',
        FAQ_ANSWER_4: 'You can purchase DIMCOIN directly through your DEPOTWALLET with NEM.',

        FAQ_QUESTION_5: 'Is DEPOTWALLET safe to use?',
        FAQ_ANSWER_5_PARA_1: 'Yes, technically DEPOTWALLET is built using the latest crypto libraries with ES6 and AngularJS. It is a full client-side application that never sends any sensitive data through the internet; everything happens in your browser from creating private keys to the signing of transactions.',
        FAQ_ANSWER_5_PARA_2: 'That means: You have full control of your assets, we never receive your private key or your password, everything you do on your wallet happens on your local computer and never leaves it.',

        FAQ_QUESTION_6: 'What is a cryptocurrency?',
        FAQ_ANSWER_6: 'Cryptocurrency is a form of digital currency, created and held electronically. It is completely decentralized and is a peer-to-peer payment network that is powered by its users with no central authority or middlemen.',

        FAQ_QUESTION_7: 'What is the Blockchain?',
        FAQ_ANSWER_7: 'It is a public ledger. This ledger contains every transaction ever processed, allowing the user\'s computer to verify the validity of each transaction. The blockchain database maintains a continuously growing list of ordered records called blocks. Each block contains a timestamp and a link to a previous block. Once recorded, the data in a block cannot be altered or changed. This way you can track your transactions to the first block.',

        FAQ_QUESTION_8: 'How do I get XEM?',
        FAQ_ANSWER_8: 'You can purchase XEM on <a href="https://changelly.com" target="_blank" style="font-size: 18px; color: inherit !important;">changelly.com</a> or <a href="https://shapeshift.io" target="_blank" style="font-size: 18px; color: inherit !important;">shapeshift.io</a>.',
        ...
        FORM_PASSPHRASE_CONFIRM: 'Confirm Password',
        FORM_CONFIRM_PASSWORD_FIELD_PLACEHOLDER: 'Confirm your password',
        FORM_PASSPHRASE_FIELD_PLACEHOLDER: 'Password',
        FORM_CONFIRM_PASSPHRASE_FIELD_PLACEHOLDER: 'Confirm your password',
        ...
        FORM_SELECT_DIMCOIN: 'Select a DIMCOIN Package',
        FORM_OTHER_AMOUNT: 'Other Amount',
        // DIM Coin module
        DIMCOIN_PACKAGE_INTRO: 'Click one of the packages below and fill in the form to buy DIM coins.',

        ACCOUNT_HIDE_PRIVATE_KEY: 'Hide private key',
        DASHBOARD_CONFIRMED_NOTHING: 'There is currently no transaction for your account.',
        DASHBOARD_UNCONFIRMED_NOTHING: 'There is currently no unconfirmed transaction for your account.'
    });
