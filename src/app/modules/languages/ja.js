function JapaneseProvider($translateProvider) {
    ...
    $translateProvider.translations('ja', {
      ...
      //dasboard component
      SEND_RECEIVED: '送信/受信',
      DECRYPT_MESSAGE: '復号化メッセージ',

      //subscribe success
      VIP_WALLET_SUBSCRIBE:'あなたのリクエストは送信されました！',
      VIP_WALLET_SUBSCRIBE_INFO:'まもなく代理店があなたの財布に関する詳細情報をご連絡いたします。 DEPOTWALLETにお問い合わせいただきありがとうございます！',

      //Passsword Validation
      PASSWORD_VALIDATION_1:"「非常に弱い！このパスワードを解読するのに約1秒かかるだろう」",
      PASSWORD_VALIDATION_2: "中級！このパスワードを解読するには約1日かかります",
      PASSWORD_VALIDATION_3:"「平均！このパスワードを解読するのに約1ヶ月かかるでしょう」",
      PASSWORD_VALIDATION_4: "強く！このパスワードを解読するには約1年かかります",
      PASSWORD_VALIDATION_5: "非常に強い！このパスワードを解読するには約2年かかります",

      DEFAULT_SCREEN:'元の設定にリセット',
      HELP_QUESTION: '助けが必要（自動応答メール）',
      HELP_ANSWER: 'あなたのお問い合わせは私たちにとって重要です。 まもなくコンサルタントがあなたに連絡します。',
      ALERT_EMAIL_DATA:"「メールアドレスを入力してください」",
      ALERT_VALID_EMAIL_DATA: 'メールは無効です！',
      WALLET_EXPORT_TITLE: '[ウォレットをエクスポート]',
      ACCOUNT_BACKUP_WALLET_SELECT: 'ウォレットを選択',
      EURO: 'ユーロ',
      GB_POUNDS: 'ポンド',
      TOTAL_CURRENCIES:'「合計通貨: ',
      NODE_ANSWER: 'ノードは、線または経路が交差または分岐するネットワーク内のポイントです。 DEPOTWALLETノードが緑色の場合、ウォレットにアクセスすることができます。ノードが赤色になるとウォレットにアクセスできず、緑色になるまでノードをクリックする必要があります',
      ////////////////////////////

      WLLET_ADDRESS_INFO_Q: 'アカウントアドレス情報 ',
      WLLET_ADDRESS_INFO_A : 'DEPOTWALLET住所は、コインを受け取る手段です。 あなたがコインを購入または販売する場合、このアドレスはあなたの取引につながり、他人があなたにコインを支払うために使用する住所として機能します。',
      ENCRYPT_DEFINITION: '暗号化定義',
      ENCRYPT_DEFINITION_ANSWER: 'あなたの情報やデータを不正なアクセスを防ぐためのコードに変換します。暗号化は、ID盗難や詐欺からデータを安全に保護するのに役立ちます。',
      DECRYPT_DEFINITION: '解読解読',
      DECRYPT_DEFINITION_ANSWER: 'あなたの情報を暗号化した後に分かりやすい情報やデータに変換します',
      //////

      //LOGIN PAGE TABS
      BASIC_WALLET: '基本財布',
      PREMIUM_WALLET: 'プレミアムウォレット',
      VIP_WALLET: 'VIPウォレット',

        //LOGIN TABS CONTAINS
        LOGIN_HEADER: 'ログイン',
        FORGET_PASSWORD: 'パスワードを忘れる',
        RECOVER_WALLET: 'ウォレットを復元する',
        BASIC_WALLET_QUESTION: 'なぜ基本財布ですか？',
        BASIC_WALLET_ANSWER: '基本ウォレットは、アカウントにアクセスするためにパスワードに加えてログインキーファイルを必要としません。 このアカウントは、初めてオンラインウォレットを使用し、500ドル以上のコインを保管することを計画していない人にとって理想的です。 それ以外の場合は、プレミアムウォレットの使用をおすすめします。',
        BASIC_WALLET_OPEN_ACCOUNT: '基本財布を開く',
        PRIMIUM_WALLET_QUESTION: 'なぜプレミアムウォレットですか？',
        PRIMIUM_WALLET_ANSWER: 'プレミアムウォレットには、ユーザーがアカウントにアクセスするためのログインキーが必要で、最高レベルのセキュリティを提供します。 このアカウントは、以前にオンラインウォレットを使用した個人に最適です。 「.wlt」ファイルとパスワードは、USBスティックや外部HDなどの複数の場所にバックアップすることをお勧めします。',
        PRIMIUM_WALLET_OPEN_ACCOUNT: 'オープンプレミアムウォレット',
        VIP_WALLET_QUESTION: "なぜVIPウォレットですか？",
        VIP_WALLET_ANSWER: 'VIPウォレットはDEPOTWALLETチームによって登録され管理されます。 このウォレットは、自分のアカウントを管理したくない個人に最適です。',

        VIP_WALLET_LOW_FEES_QUESTION: 'VIPウォレット料金情報：',
        VIP_WALLET_LOW_FEES_ANSWER: '年間999ドル。',

        VIP_WALLET_PRISE_LIST: '料金表を見る',
        VIP_WALLET_OPEN_ACCOUNT: '申し込む',
        VIP_WALLET_SUBSCRIB_EMAIL_LABEL: 'あなたの電子メール',
        VIP_WALLET_SUBSCRIB_EMAIL_PLACEHOLDER: 'info @ johndoe',
        VIP_WALLET_SUBSCRIB_BUTTON: '申し込む',
        BASIC_WALLET_INFO_1: '登録の最初のステップ',
        BASIC_WATCH_VIDEO: 'ビデオを見る',
        BASIC_VIEW_PDF: 'PDFを見る',
        BASIC_CONTINUES: '持続する',
        ACCOUNT_COMMON_WALLET_WARNING_CONFIRM: '同意する',
        FORM_WALLET_NAME_PLACEHOLDER: '例えば。 ジョン・プライベート・アカウント',
        SIGNUP_CREATE_WALLET_PRIMIUM_BUTTON: 'プレミアムウォレットを作成する',

        //Open Account
        ACCOUNT_WARNING_1: 'アカウントの安全に関する警告',
        ACCOUNT_WARNING_2: 'ダウンロード.wltファイル',
        ACCOUNT_WARNING_3: '.wltファイルを外部に保存する',
        ACCOUNT_WARNING_4: 'あなたの秘密鍵',
        ACCOUNT_WARNING_5: '秘密鍵をオフラインで保存する',
        ACCOUNT_WARNING_6: '登録を完了する',

        ACCOUNT_WARNING_INFO_1: "ウォレットはブラウザのローカルストレージに一時的に保存されます。 ブラウザは、ローカルストレージ時間をクリアするように（例えば、アドオンによって）構成することができる。 これにより、データが失われる可能性があります。この場合、簡単に取り消すことはできません。この場合、ウォレットにアクセスできなくなります。 あなたのアカウントを復元するために必要なすべての情報とデータ（.wlt）を持っていることが最も重要です。",
        ACCOUNT_WARNING_INFO_2_1: 'ウォレットを作成した後でダウンロードを開始したはずです。これはブラウザのローカルストレージが消去された場合にバックアップとインポートに使用される" .wlt "ファイルです。',

        ACCOUNT_WARNING_INFO_2_2: 'バックアップ" .wlt "ファイルがない場合は、下のボタンをクリックして生のウォレットデータを表示し、ファイルを手動で作成してください。',
        ACCOUNT_WARNING_INFO_3: '外付けストレージに" .wlt "ファイルを保存するこれはUSBフラッシュドライブまたは外付けハードドライブ上にある可能性があります。このファイルとパスワードは、アカウントへのアクセスであるため安全な場所に保管してください。 ファイルが失われても復元できません。',
        ACCOUNT_WARNING_INFO_4: 'ウォレットファイルを持っていても、アカウントの秘密鍵をバックアップする必要があります。このファイルはアカウントへのアクセスであるため、安全な場所に保管してください。 あなたのプライベートキーを明らかにする：',

        ACCOUNT_WARNING_INFO_5: "秘密鍵をバックアップするには、テキストファイルに保存するか、印刷するか、安全な場所に書き留めてください。秘密鍵はオフラインで保存することをお勧めします。",
        ACCOUNT_WARNING_INFO_6: "上記をクリックすると、上記のセキュリティ警告とDEPOTWALLETの利用規約を読み、理解したことに同意したことになります。",
        CHECK_PASSWORD__CHECKED: "パスワードを入力してください'チェックボックス",

        //open Account Agrree btn
        ACCOUNT_AGRREE_PASSWORD: '私は自分のパスワードを持っています」',
        ACCOUNT_AGRREE_WALLET_FILE: '私の ".wlt"キーファイル "を持っています。',
        ACCOUNT_AGRREE_PRIVATE_KEY: '「私の秘密鍵を紙に書き留めました」',

        BASIC_PASSWORD_REQ: 'パスワード要件',
        BASIC_PASSWORD_QUESTION_1: '',
        BASIC_PASSWORD_ANSWER_1: 'DEPOTWALLETはKeepass、<u>1Password</u>、<u>Lastpass</u> などのパスワード管理ソフトウェアの使用を強くお勧めします。パスワードマネージャーは、訪問した各Webサイトごとにランダムで一意のパスワードを生成することができます。自動的にパスワードを入力し、フィッシング攻撃から身を守ることができます。',
        BASIC_PASSWORD_QUESTION_2:'「良いパスワードを選択するにはどうすればいいですか？」',
        BASIC_PASSWORD_ANSWER_2: "パスワードマネージャを使用したくない場合は、DEPOTWALLETアカウントに固有の長くてランダムなパスワードを使用してください。他のウェブサイト、特にあなたのメールアカウントのパスワードを再利用しないでください。文または単語のグループ）、ハッカーがそのような引用の洗練されたデータベースにアクセスできるように、本や映画のフレーズを使用しないでくださいパスワードには最低64文字を含める必要があります。",


        PRIMIUM_PASSWORD_REQ: 'パスワード要件',
        PRIMIUM_PASSWORD_QUESTION_1: '',
        PRIMIUM_PASSWORD_ANSWER_1: 'DEPOTWALLETはKeepass、<u>1Password</u>、<u>Lastpass</u> などのパスワード管理ソフトウェアの使用を強く推奨します。パスワードマネージャーは、訪問した各Webサイトごとにランダムで一意のパスワードを生成することができます。自動的にパスワードを入力し、フィッシング攻撃から身を守ることができます。 ',
        PRIMIUM_PASSWORD_QUESTION_2:'「良いパスワードを選ぶにはどうすればいいですか？」',
        PRIMIUM_PASSWORD_ANSWER_2: "パスワードマネージャを使用したくない場合は、DEPOTWALLETアカウントに固有の長くてランダムなパスワードを使用してください。他のウェブサイト、特にあなたのメールアカウントのパスワードを再利用しないでください。ハッカーがこのような引用符の洗練されたデータベースにアクセスできるように、書籍や映画のフレーズを使用しないでください。パスワードは30文字以上必要です。",

        WALLET_NAME_REQ: '「ウォレット名情報」',
        WALLET_NAME_QUESTION_1: '',
        WALLET_NAME_ANSWER_1: 'DEPOTWALLETアカウントを作成する際にあなたの財布に記入した名前',
        WALLET_NAME_QUESTION_2: '',
        WALLET_NAME_ANSWER_2: "",

        ACCOUNT_INFO_PUBLIC_TITLE: '公開鍵',
        PASSWORD_PUBLIC_REQ: '',
        PASSWORD_PUBLIC_QUESTION_1: 'アカウントの公開鍵情報',
        PASSWORD_PUBLIC_ANSWER_1: 'これは、他のアドレスが作成されるDEPOTWALLETアドレスの拡張版です。',

        ACCOUNT_INFO_SCORE_TITLE: '重要度スコアのタイトル',
        PASSWORD_SCORE_REQ: '「重要度スコア」',
        PASSWORD_SCORE_QUESTION_1:'「重要度スコアの質問」',
        PASSWORD_SCORE_ANSWER_1:'「重要度スコアの回答」',

        ACCOUNT_INFO_BALANCE_TITLE:'「確定残高タイトル」',
        PASSWORD_BALANCE_REQ: '既得残高要求',
        PASSWORD_BALANCE_QUESTION_1:'「未確定残高照会？」',
        PASSWORD_BALANCE_ANSWER_1:'「既得残高回答」',

        //Steps Arrow btn
        STEP_BIP32: 'BIP32に関する詳細情報',
        STEP_ROW_FILE: '生のウォレットファイルを表示する',
        STEP_DOWNLOAD_FILE: 'ダウンロードファイル',
        STEP_SHOW_PRIVATE_KEY: '秘密鍵を表示する',
        STEP_DOWNLOAD_PRIVATE_KEY: '秘密鍵をダウンロードする',

        RECOVER_WALLET_INFO: 'ウォレットを復元する',
        RECOVER_WALLET_P1: 'あなたの秘密鍵で紛失した場合、あなたの財布は元に戻すことができます。',

        //Footer
        FOOTER_DESCLIMER: '「免責事項」',
        FOOTER_TIMEZONE: 'タイムゾーン：GMT',

        //Disclimer page
        DISCLIMER_TITLE:'「免責事項」',
        DISCLIMER_QUESTION: '',
        DISCLIMER_ANSWER:'DEPOTWALLETは、ウォレットアドレス、秘密鍵またはパスワードの安全な保管に責任を負いません。 秘密鍵が失われたら、バックアップと保管は責任があるため、DEPOTWALLETで回復することはできません',
        ...
        //Dashboard page
        //Dashboard page
        DASHBOARD_TITLE_ADDRESS: 'あなたのアカウントアドレス',
        DOWNLOAD: 'ダウンロード',
        COPY: 'コピー',
        VIEW: 'ビュー',
        INFO: '情報',
        ...
        US_DOLLAR: '米ドル',
        IN_RUPEE: 'インルピー',
        CHF_FRANCE: 'CHF-スイスフラン',

        STOCK_EXCHANGE: '証券取引所',
        OTC_MARKET: '店頭市場',
        CURRENCIES: '通貨',
        YOUR_CURRENCIES: 'あなたの通貨',
        YOUR_SETTING: 'あなたの設定',
        SELECT_LANGUAGE: '言語を選択する',
        SELECT_YOUR_LANGUAGE: 'あなたの言語を選択してください',
        SELECT_LANGUAGE_INTRO: 'このページは以下の言語で利用可能です：',
        CHANGE_BACK_COLOR: '背景色を変更する',
        QR_CODE_INFO: 'DEPOTWALLETでは、NEMベースのコインのみを使用できます。 DEPOTWALLETを介してすべてのaltcoinsを送受信することはできません。 交換可能なaltcoinsには以下が含まれます：XEM、DIM',
        QR_CODE_TITLE: 'アカウントアドレスQRコードの安全に関する警告',
        COPIED_CLIPBOARD: 'コピーされました！',
        ...
        //Exchange page
        EXCHANGE_LABEL_CURRENCY: '通貨を選択',
        EXCHANGE_LABEL_SELECT_PAYMENT: '支払い方法の選択',

        //tranfer tranjection
        GENRAL_NEXT: '次',
        GENRAL_BACK: 'バック',
        VIEW_BLOCKCHAIN: 'ブロックチェーンでの表示',
        HISTROY_RESENT_ACTIVITY: '最近の活動の歴史',
        ...
        //recover wallet
        GENRAL_FIND: '検索',
        RECOVER_INFO_TITLE: 'ウォレットを復元する',
        RECOVER_PASSWORD_REQ: '秘密鍵情報',
        RECOVER_PASSWORD_QUESTION_1: 'なぜ秘密鍵情報ですか？',
        RECOVER_PASSWORD_ANSWER_1: '秘密鍵は洗練された形式の暗号方式で、DEPOTWALLET内の暗号侵害にアクセスすることができます。 秘密鍵は、そのセキュリティ構成が資金への不正アクセスからの保護を確実にするのに役立ち、暗号侵害の使用に不可欠です。',
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      HEADER_NODE_BLOCK_HEIGHT: "ブロック高さ",
      ...
      HEADER_SIGNUP_WARNNING:'安全のための指示',
      HEADER_FAQ_BUTTON:'よくある質問',
      ...
      // FOOTER COMPONENT
      FOOTER_POWERED_BY_1: '搭載',
      FOOTER_POWERED_BY_2: 'テクノロジーではありません。',
      FOOTER_VERSION: "バージョン",
      GENERAL_PRICE: '価格',
      ASSETS_EXPLORER_MAX_QUANTITY:'最大購入可能数量',
      DIMCOIN_BUY_LABEL:'購入',


      TOOLTIPS_ACCOUNT_INFO:'安全のための指示',
      // DASHBOARD MODULE
      ...
      DASHBOARD_NOTICE_5: 'あなたの参加に感謝します！',
      ...
      GENERAL_BLOCK: "ブロック",
      GENERAL_BLOCKS: 'ブロック',
      GENERAL_NO_RESULTS: "表示するものは何もない",
      ...
      TRANSFER_TRANSACTION_SIDEBAR1_TITLE: 'コイン振込',
      TRANSFER_TRANSACTION_SIDEBAR2_TITLE: '資産移転',
      TRANSFER_TRANSACTION_SIDEBAR3_TITLE: '暗号化されたメッセージ',
      TRANSFER_TRANSACTION_SIDEBAR1_TEXT: 'パスワードを入力し、コインを送る場所を指定し、金額を入力して「送信」をクリックします。 これには手数料が必要です。',
      TRANSFER_TRANSACTION_SIDEBAR2_TEXT: '[資産転送]の[はい]チェックボックスをオンにすると、資産を送信できます。 これには手数料が必要です。',
      TRANSFER_TRANSACTION_SIDEBAR3_TEXT: 'メッセージを暗号化する場合は「はい」を選択してください。これは強くお勧めします。 これには手数料が必要です。',
      TRANSFER_TRANSACTION_NEEDSXEM_TEXT: 'XEMを使用しないで取引することはできません。 <a href="https://changelly.com" target="_blank" style="font-size: 18px;">changelly.com</a> または <a href="https://shapeshift.io" target="_blank" style="font-size: 18px;">shapeshift.io</a>.',
...
　　　　　　　　　　　　NAMESPACE_PROVISION_INFORMATION_3: 'このリストは最終的なものではなく、将来拡張される事があります。 したがって、\'user.alice\' または \'alice.user\' はNEMのネームスペースでは使用できません。ネームスペースには最大3つの部分で構成されるので、\'gimre.metals.silver\'は有効ですが、\'gimre.metals.silver.coin\' は有効ではありません。',
      ...
      // ACCOUNT MODULE
      ACCOUNT_TITLE: "アカウント",
      ACCOUNT_ACCOUNT_INFORMATION: "情報",
      ...
      ACCOUNT_PRIVATE_KEY_NOTE: "秘密鍵はアカウントのすべての権限を保持します。 .wltファイルに暗号化されたパスワード、紙の上に書かれたパスワード、写真の上に書かれたパスワード、またはエクスポートウォレットのQRをダウンロードすることが、オフラインのどこかに安全に保存されていることを確認することが優先事項です。",
      ACCOUNT_PRIVATE_KEY_SHOW: "秘密鍵を表示",
      ACCOUNT_EXPORT_MOBILE: "輸出する",
      ACCOUNT_INFO_TITLE: 'ウォレットをエクスポートする',
      ACCOUNT_INFO_QR_BTN: "アカウント情報",
      ACCOUNT_WALLET_QR_BTN: "財布",
      ACCOUNT_WALLET_QR_BTN_2: "Android / ios",
      ACCOUNT_BACKUP_WALLET: "バックアップ",
      ACCOUNT_BACKUP_WALLET_NOTE: "財布のバックアップを取ってログインすることが非常に重要です。そうしないと、XEMが失われます。",
      ACCOUNT_BACKUP_WALLET_DOWNLOAD: "ウォレットをダウンロード",
      ACCOUNT_INFO_QR_TITLE: "アカウント情報 QR",
      ACCOUNT_WALLET_QR_NOTE: "このQRは今後のデポペイモバイルアプリでのみ動作しています。",
...
　　　　　　　　　　　　APOSTILLE_REQUEST_MESSAGE: 'リクエストメッセージ',
      ...
      // ERROR ALERTS
      ALERT_MISSING_FORM_DATA: "フォームに記入してください",
      ALERT_BAD_PASSWORD_DATA: '最小文字数64、少なくとも1大文字、1数字、1特殊文字を持つパスワードを入力してください。 スペースは許されません。',
      ALERT_BAD_PASSWORD_DATA_2: '少なくとも30文字の大文字、1数字、1文字の特殊文字を持つパスワードを入力してください。 スペースは許されません',
      ...
      ALERT_WALLET_NAME_EXISTS: "同じ名前の財布がすでに積み込まれています！",
      ...
      ALERT_MULTISIG_MIN_SIGNATURE: 'マルチサインアカウントには少なくとも1つの最小署名が必要です',
      ALERT_BTC_MARKET_ERROR: 'Bitcoinの価格を取得しようとしているときにエラーが発生しました',
      ALERT_COSIG_REMOVAL_LIMIT: '一度に1つの補助記号のみを取り除くことができます',
      ALERT_MULTISIG_MIN_SIGNATURE_INVALID: '最小署名の数が無効です',
      ALERT_CURRENCIES_EXCHANGE_DOWN: 'エラーが発生しました：通貨は現在変換できません',
      ALERT_BRAIN_WALLET_UPGRADE: '<span>あなたのパスワードは弱いですね！ 最低64文字のパスフレーズを使用することをお勧めします。</span><br /><span>「基本ウォレット」がまだ手元にある場合は、新しい「プレミアムウォレット」を作成し、それに資金を移すことをおすすめします。</span><br/><span>',
      ALERT_BRAIN_PASSWORD_TOO_SHORT: '基本的なウォレットのパスフレーズは、少なくとも64文字でなければなりません！',
      ALERT_PREMIUM_PASSWORD_TOO_SHORT: 'プレミアムウォレットのパスフレーズは64文字以上である必要があります。',
      ALERT_BASIC_WALLET_MUST_BE_LOADED: '基本口座にログインする前に口座を開設してください！',
      ALERT_BRAIN_WALLET_UPGRADE_TITLE: 'セキュリティ警告',
      ...
      LOGIN_SELECT_WALLET_YOURS: 'ウォレットを選択',
      LOGIN_SELECT_WALLET: "ストレージ内のウォレットを選択する",
      ...
      SIGNUP_BRAIN_WALLET_BUTTON: "基本財布の作成",
      ...
      SIGNUP_COMMON_WALLET_WARNING: 'ウォレットは、<a>一時的に</a>ブラウザ内のローカルストレージに保存されます。ウォレット作成後に自動的にダウンロードされる.wltファイルはバックアップとして利用します。ブラウザのローカルストレージが削除された場合は、このファイルからインポート可能です。バックアップとして、.wltファイルを保存していない場合は、アカウントにログインして、秘密鍵をコピーし安全な場所にバックアップして下さい。バックアップされている事を確認してから、自己の責任に於いてアカウントに資金を送金してください。',

      SIGNUP_COMMON_WALLET_WARNING_TITLE: 'アカウントの安全に関する警告',
      SIGNUP_COMMON_WALLET_WARNING_1: 'ウォレットはブラウザのローカルストレージに一時的に保存されます。 ブラウザは、時にはローカルストレージをクリアするように（例えば、アドオンによって）構成することができる。 これによりデータが失われ、簡単に取り消すことができなくなります。 そのような場合、財布はなくなりますので、アカウントを復元するために必要な情報がすべて揃っていることを確認することが非常に重要です。',
      SIGNUP_COMMON_WALLET_WARNING_2: 'ウォレットを作成した後、ダウンロードを開始したはずです。 バックアップとして使用され、ブラウザのローカルストレージが消去された場合にインポートするのは<b> <i> .wlt </ i> </ b>ファイルです。',
      SIGNUP_COMMON_WALLET_WARNING_3: 'バックアップ<b> <i> .wlt </ i> </ b>ファイルが表示されない場合は、下のボタンをクリックして生のウォレットデータを表示し、ファイルを手動で作成します。',
      SIGNUP_COMMON_WALLET_WARNING_4: 'ウォレットファイルを持っていても、アカウントの秘密鍵をバックアップするには<b> <u>必須</ u> </ b>ですが、',
      SIGNUP_COMMON_WALLET_WARNING_5: 'アカウントに資金を送る前に、秘密鍵のバックアップを必ず取っておくことは、あなたの責任です。',
      SIGNUP_COMMON_WALLET_WARNING_6: '各ウォレットには、決定性セカンダリアカウント（BIP32）の作成に使用される<b> <u>プライベート秘密鍵</ b> </ b>（上図参照）があります。 この機能は<b> <u>同じパスワード</ u> </ b>を使用する必要があります。同じプライマリ秘密鍵に対して異なるセカンダリアカウントを生成します。 あなたのデータをバックアップするときは、<b> <u>あなたのパスワードを書き留めて</ u> </ b>することを忘れないでください。',
      SIGNUP_COMMON_WALLET_WARNING_BTN_1: '生のウォレットファイルを表示する',
      SIGNUP_COMMON_WALLET_WARNING_BTN_1_INFO: 'ウォレット・ファイルを作成するには、空のテキスト・ファイルを作成し、上記のベース64キーをそこに入れます。 <br>ファイルを<b> <i> yourWalletName.wlt </ i> </ b>という名前で保存して、インポートすることができます。',
      SIGNUP_COMMON_WALLET_WARNING_BTN_2: '秘密鍵を表示する',
      SIGNUP_COMMON_WALLET_WARNING_BTN_2_INFO: '秘密鍵をバックアップするには、テキストファイルに保存して印刷するか、安全な場所に書き込んでください。 <br>秘密鍵はオフラインで保存することをお勧めします。',
      SIGNUP_COMMON_WALLET_WARNING_FOOTER: '下記をクリックすると、上記の警告を読み、理解したことに同意したことになります。',
      SIGNUP_COMMON_WALLET_WARNING_CONFIRM_1: '私は財布ファイルを持っています',
      SIGNUP_COMMON_WALLET_WARNING_CONFIRM_2: '私は自分の秘密鍵とパスワードを持っています',
      SIGNUP_COMMON_WALLET_WARNING_CONFIRM_3: '承諾します',
      SIGNUP_COMMON_WALLET_WARNING_CONFIRM_4: '私は安全のための指示を読んで受け入れました',


      // FAQ MODULE
      FAQ_TITLE: 'よくある質問',
      FAQ_QUESTION_1: 'DEPOTWALLETとは何ですか？',
      FAQ_ANSWER_1: '私たちはDEPOTWALLETと呼ばれる最先端の2-in-1ブロックチェーン財布を提供しています。 コインウォレット：DIMCOINをインターネット経由でどこからでもアクセスできる安全な場所に購入、販売、保留します。<br><br> 資産財布：株式、ETF、EEPなどの資産をDEPOTWALLETで購入、売買、保有します。',

      FAQ_QUESTION_2: 'DIMCOINとは何ですか？',
      FAQ_ANSWER_2: 'DIMCOINは、暗号化と呼ばれるデジタルマネーの一般的なカテゴリに属するデジタル通貨であり、電子的に作成され格納され、適切に分散されています。 インターネットは非常にシンプルで効率的な方法で。',

      FAQ_QUESTION_3: 'なぜDIMCOINを使うのですか？',
      FAQ_ANSWER_3: 'DIMCOINのようなクリプトクールの使用には多くの興味があり、その中には次のものがあります：',
      FAQ_ANSWER_3_LI1: 'セキュリティ - 個人情報が取引に関連付けられていないため、取引を引き続き制御し、個人情報の盗難から安全です',
      FAQ_ANSWER_3_LI2: '低コスト - 非常に低い取引手数料や第三者が関与しているため、売買のコストが大幅に削減されます。',
      FAQ_ANSWER_3_LI3: 'すばやく便利 - DIMCOINは世界中どこでも数分で送受信できます。',

      FAQ_QUESTION_4: 'DIMCOINはどのように入手できますか？',
      FAQ_ANSWER_4: 'DIMCOINはNEMでDEPOTWALLETから直接購入することができます。',

      FAQ_QUESTION_5: 'DEPOTWALLETは安全に使用できますか？',
      FAQ_ANSWER_5_PARA_1: 'はい、技術的にはDEPOTWALLETは、ES6とAngularJSで最新の暗号ライブラリを使用して構築されています。インターネット経由で機密データを送信したことのない完全なクライアント側アプリケーションです。',
      FAQ_ANSWER_5_PARA_2: 'これは、資産を完全に管理していることを意味し、秘密鍵やパスワードを受け取ることはありません。財布上のすべてのことは、ローカルコンピュータで行われ、決して離れることはありません。',

      FAQ_QUESTION_6: '暗号侵害とは何ですか？',
      FAQ_ANSWER_6: '暗号化は、電子的に作成されて保持されているデジタル通貨の一形態であり、完全な分散型であり、中央の権限や仲介者をもたないユーザーによって強化されたピアツーピア決済ネットワークです。',

      FAQ_QUESTION_7: 'ブロックチェーンとは何ですか？',
      FAQ_ANSWER_7: 'それは公共の元帳です。 この元帳には、これまで処理されたすべてのトランザクションが含まれており、ユーザーのコンピュータは各トランザクションの有効性を検証できます。 ブロックチェーンデータベースは、ブロックと呼ばれる順序付けられたレコードの連続的に増加するリストを維持する。 各ブロックには、タイムスタンプと前のブロックへのリンクが含まれています。 一度記録されると、ブロック内のデータを変更または変更することはできません。 これにより、トランザクションを最初のブロックまで追跡することができます。',

      FAQ_QUESTION_8: 'XEMはどのように入手できますか？',
      FAQ_ANSWER_8: '<a href="https://changelly.com" target="_blank" style="font-size:18px;color:inherit !important;"> changelly.com </a>または<a href = "https://shapeshift.io" target = "_blank" style = "font-size：18px; color：inherit！important;"> shapeshift.io </a>',
      ...
      FORM_PASSWORD: 'パスワード',
      FORM_PASSWORD_CONFIRM: 'パスワードを認証する',
      FORM_PASSPHRASE_CONFIRM: 'パスワードを認証する',
      FORM_CONFIRM_PASSWORD_FIELD_PLACEHOLDER: "パスワードを確認",
      FORM_PASSPHRASE_FIELD_PLACEHOLDER: "パスワード",
      ...
      FORM_QR_BUTTON:'QRコード',
      FORM_SELECT_DIMCOIN:'DIMCOINパッケージを選択',
      FORM_OTHER_AMOUNT:'その他の金額',
      // DIM Coin module
      DIMCOIN_PACKAGE_INTRO: '下記のいずれかのパッケージをクリックし、DIMコインを購入するフォームに記入してください。',

      ACCOUNT_HIDE_PRIVATE_KEY: '秘密鍵を隠す',
      DASHBOARD_CONFIRMED_NOTHING: '現在、お客様のアカウントには取引がありません。',
      DASHBOARD_UNCONFIRMED_NOTHING: '現在、お客様のアカウントに未確認取引はありません。'
    });
