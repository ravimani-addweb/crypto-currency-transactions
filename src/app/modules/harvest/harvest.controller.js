...
class HarvestCtrl {
    constructor(AppConstants,Wallet, Alert, $location, DataBridge, $scope, $filter, Transactions, NetworkRequests) {
        'ngInject';
